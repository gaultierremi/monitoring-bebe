...
export default function LegumesModal({ onClose }: Props) {
    ...
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/50 px-4 pb-4 sm:pb-0">
      <div className="w-full max-w-sm rounded-2xl bg-white p-6 space-y-5 shadow-xl">
        <div className="flex items-center justify-between">
          <h2 className="text-xl font-bold text-gray-900">🥦 Légumes</h2>
          <button
            onClick={onClose}
        ...
        <div className="flex gap-3 pt-1">
          ...
          <button
            onClick={handleSave}
            disabled={isPending}
            className="flex-1 rounded-xl bg-green-600 px-4 py-3 text-base font-semibold text-white hover:bg-green-700 disabled:opacity-60"
          >
